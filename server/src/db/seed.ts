...
async function seed() {
  ...
  const q2Asg: Array<[string, string, number]> = [
    ...
    ["Meng Xu","cell",0.8],["Michael Krishnan","cell",0.8],["Shenglin Du","cell",0.6],
    ["Austen Schunk","raft",0.8],["Hieu Pham","raft",0.8],["George Li","cell",0.4],
    ["Gavin Wang","frost",0.5],["Qinghua Chen","bandrestore",0.5],
    ...
    ["Anders Persson","raasstd",0.8],["Utkarsh Singh","raasstd",0.8],["Vineesha Kasireddy","raasstd",0.8],["Pranish Pantha","raasstd",0.2],["Yue Luo","raasstd",0.8],
    ...
    ["Zijian Xie","pgint",0.5],["George Li","pgint",0.2],
